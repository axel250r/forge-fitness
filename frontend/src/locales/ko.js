...
export default {
  ...
  'Search or filter by body part and equipment. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.': "부위와 장비로 검색하거나 필터링하세요. 운동을 눌러 전체 설명과 시범 영상을 보거나, '계획'을 눌러 바로 루틴에 추가하세요.",
  'Got it': "확인했어요",
