...
export default {
  ...
  'Forge shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Forge는 오늘 계획된 루틴을 보여주고 지난번 무게를 미리 채워줘요. 세트를 기록할 때마다 휴식 타이머와 중량 진행이 자동으로 작동해요.",
  ...
  'Rest-timer alerts, even if Forge is closed.': 'Forge이 닫혀 있어도 휴식 타이머 알림을 받아요.',
  ...
  'A small file a friend imports into their own Forge — routines only, none of your workouts or weigh-ins.': '친구가 자신의 Forge으로 가져올 수 있는 작은 파일 — 루틴만 포함되며 운동 기록이나 체중은 포함되지 않습니다.',
  ...
  "Checking…": "확인 중…",
  "You’re a Forge Premium member": "Forge 프리미엄 멤버입니다",
  "Welcome to Forge Premium!": "Forge 프리미엄에 오신 것을 환영합니다!",
