...
export default {
  "This exercise is part of Loadout Premium — skip it or unlock full access to train it.": "이 운동은 Loadout 프리미엄에 포함되어 있어요 — 건너뛰거나 전체 이용권을 잠금 해제해서 훈련하세요.",
  ...
  "This exercise, its demo video and full instructions are part of Loadout Premium.": "이 운동과 시범 영상, 전체 설명은 Loadout 프리미엄에 포함되어 있어요.",
  "Unlock Loadout Premium": "Loadout 프리미엄 잠금 해제",
  ...
  "Subscribe — {0}/month": "구독하기 — 월 {0}",
  "Subscriptions aren’t live yet — check back soon.": "구독은 아직 준비 중이에요.",
  "Maybe later": "나중에",
  "Premium": "프리미엄",
  'This is your week at a glance. Tap Start to train today’s routine, or log your body weight below to track it over time.': "한눈에 보는 이번 주예요. 오늘의 루틴을 시작하려면 '시작'을 누르거나, 아래에서 체중을 기록해 변화를 추적하세요.",
  'Tap a day to assign it a routine. Tap a routine below to edit its exercises — or load a starter plan if you don’t have one yet.': "요일을 눌러 루틴을 지정하세요. 아래 루틴을 눌러 운동을 편집하거나 — 아직 루틴이 없다면 스타터 플랜을 불러오세요.",
  'Loadout shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Loadout는 오늘 계획된 루틴을 보여주고 지난번 무게를 미리 채워줘요. 세트를 기록할 때마다 휴식 타이머와 중량 진행이 자동으로 작동해요.",
  'Track your body weight trend, workout streak, estimated 1RM and which muscles you’ve trained. Tap any exercise below to see its full history.': "체중 변화, 연속 운동 기록, 예상 1RM, 단련한 근육을 확인하세요. 아래 운동을 눌러 전체 기록을 볼 수 있어요.",
  'Gym': "헬스장",
  'At home': "집에서",
  "Search or filter by body part and equipment. Switch Gym / At home to only see exercises you can actually do there. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.": "신체 부위와 장비로 검색하거나 필터링하세요. 실제로 할 수 있는 운동만 보려면 헬스장 / 집에서를 전환하세요. 운동을 탭하면 전체 안내와 시연 영상을 볼 수 있고, 플랜을 탭하면 루틴에 바로 추가할 수 있습니다.",
  'Got it': "확인했어요",
  'Prefer to figure things out yourself?': "직접 알아보고 싶으신가요?",
  'Turn tips off here': "여기서 팁 끄기",
  'Contextual tips': "상황별 팁",
  'Short notes on each screen, the first time you open it': "각 화면을 처음 열 때 나오는 짧은 안내",
  'Confirm': '확인',
  'Cancel': '취소',
  'Delete': '삭제',
  'Save': '저장',
  ...
  'routine': '루틴',
  'Cardio': '유산소',
  'Short on time': "시간이 부족할 때",
  '{0} min · Follow along on YouTube': "{0}분 · 유튜브 영상 따라하기",
  'Mobility': "가동성",
  'Upper Body': "상체",
  'Lower Body': "하체",
  'Superset': '슈퍼세트',
  ...
  'open source (AGPL v3)': '오픈소스 (AGPL v3)',
  'Notifications': '알림',
  'Not supported in this browser.': '이 브라우저에서는 지원되지 않아요.',
  'Push notifications': '푸시 알림',
  'Rest-timer alerts, even if Loadout is closed.': 'Loadout이 닫혀 있어도 휴식 타이머 알림을 받아요.',
  ...
  'A small file a friend imports into their own Loadout — routines only, none of your workouts or weigh-ins.': '친구가 자신의 Loadout으로 가져올 수 있는 작은 파일 — 루틴만 포함되며 운동 기록이나 체중은 포함되지 않습니다.',
  ...
  'this isn’t a Loadout plan file': 'Loadout 계획 파일이 아닙니다',
  'Shared routine': '공유된 루틴',
  'Unknown exercise': '알 수 없는 운동',
  'Weekly Training Plan': '주간 트레이닝 계획',
  'Made with Loadout': 'Loadout으로 제작',
  ...
  "Reload Loadout": "Loadout 다시 불러오기",
  ...
  "Exercise": "운동",
  "Push / Pull / Legs": "푸시 / 풀 / 하체",
  "3x/week · Mon Push · Wed Pull · Fri Legs": "주 3회 · 월 Push · 수 Pull · 금 하체",
  "Upper / Lower": "상체 / 하체",
  "4x/week · Mon+Thu Upper · Tue+Fri Lower": "주 4회 · 월+목 상체 · 화+금 하체",
  "Full Body": "전신",
  "3x/week · Mon · Wed · Fri": "주 3회 · 월 · 수 · 금",
  "5×5 Strength": "5×5 근력",
  "3x/week · alternating A/B · Mon A · Wed B · Fri A": "주 3회 · A/B 교대 · 월 A · 수 B · 금 A",
  ...
  "Active — manage or cancel anytime in Google Play.": "활성 상태 — Google Play에서 언제든지 관리하거나 취소할 수 있습니다.",
  "{0}/month · full library, every starter plan": "월 {0} · 전체 라이브러리, 모든 시작 플랜",
  "Already subscribed on another device?": "다른 기기에서 이미 구독 중인가요?",
  "Checking…": "확인 중…",
  "You’re a Loadout Premium member": "Loadout 프리미엄 멤버입니다",
  "Welcome to Loadout Premium!": "Loadout 프리미엄에 오신 것을 환영합니다!",
  "Subscriptions are only available in the Play Store version of the app.": "구독은 앱의 Play 스토어 버전에서만 이용할 수 있습니다.",
  "Subscription restored.": "구독이 복원되었습니다.",
  "No active subscription found for this account.": "이 계정에 활성 구독이 없습니다.",
  "Active — a gift, free forever.": "활성 상태 — 선물, 평생 무료입니다.",
  "Redeem gift code": "선물 코드 사용",
  "Someone gave you a code for free Loadout Premium. Enter it below.": "누군가 무료 Loadout 프리미엄 코드를 선물했습니다. 아래에 입력하세요.",
  "Gift code": "선물 코드",
  "Redeem": "사용",
  "Loadout Premium unlocked — enjoy!": "Loadout 프리미엄이 잠금 해제되었습니다 — 즐겨보세요!",
  "That code isn’t valid — check it and try again.": "유효하지 않은 코드입니다 — 확인 후 다시 시도하세요.",
}
