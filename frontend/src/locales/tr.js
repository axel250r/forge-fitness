...
export default {
  "This exercise is part of Loadout Premium — skip it or unlock full access to train it.": "Bu egzersiz Loadout Premium'un bir parçası — atla ya da yapmak için tam erişimin kilidini aç.",
  ...
  "This exercise, its demo video and full instructions are part of Loadout Premium.": "Bu egzersiz, tanıtım videosu ve tam talimatlar Loadout Premium'un bir parçasıdır.",
  "Unlock Loadout Premium": "Loadout Premium'un kilidini aç",
  ...
  "Subscribe — {0}/month": "Abone ol — {0}/ay",
  "Subscriptions aren’t live yet — check back soon.": "Abonelikler henüz kullanılamıyor.",
  "Maybe later": "Daha sonra",
  "Premium": "Premium",
  'This is your week at a glance. Tap Start to train today’s routine, or log your body weight below to track it over time.': "İşte haftan bir bakışta. Bugünkü antrenmanı yapmak için Başla'ya dokun, ya da kilonu zaman içinde takip etmek için aşağıya kaydet.",
  'Tap a day to assign it a routine. Tap a routine below to edit its exercises — or load a starter plan if you don’t have one yet.': "Bir güne antrenman atamak için üzerine dokun. Egzersizlerini düzenlemek için aşağıdan bir antrenmana dokun — henüz yoksa bir başlangıç planı yükle.",
  'Loadout shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Loadout bugün planlanan antrenmanı gösterir ve geçen seferki ağırlıklarını otomatik doldurur. Her seti kaydettikçe dinlenme sayacı ve ilerleme otomatik çalışır.",
  'Track your body weight trend, workout streak, estimated 1RM and which muscles you’ve trained. Tap any exercise below to see its full history.': "Kilo eğrini, antrenman serini, tahmini 1RM'ini ve çalıştığın kasları takip et. Tüm geçmişini görmek için aşağıdan bir egzersize dokun.",
  'Gym': "Spor salonu",
  'At home': "Evde",
  "Search or filter by body part and equipment. Switch Gym / At home to only see exercises you can actually do there. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.": "Vücut bölümüne ve ekipmana göre ara veya filtrele. Orada gerçekten yapabileceğin egzersizleri görmek için Spor salonu / Evde arasında geçiş yap. Tam talimatları ve demo videosunu görmek için bir egzersize dokun, ya da doğrudan bir rutine eklemek için Plan’a dokun.",
  'Got it': "Anladım",
  'Prefer to figure things out yourself?': "Kendin keşfetmeyi mi tercih edersin?",
  'Turn tips off here': "İpuçlarını buradan kapat",
  'Contextual tips': "Bağlamsal ipuçları",
  'Short notes on each screen, the first time you open it': "Her ekranı ilk açtığında kısa notlar",
  'Confirm': 'Onayla',
  'Cancel': 'İptal',
  'Delete': 'Sil',
  'Save': 'Kaydet',
  ...
  'routine': 'rutine',
  'Cardio': 'Kardiyo',
  'Short on time': "Az zaman",
  '{0} min · Follow along on YouTube': "{0} dk · YouTube'daki videoyu takip et",
  ...
  'Load starter plan': 'Başlangıç planını yükle',
  ...
  'open source (AGPL v3)': 'açık kaynak (AGPL v3)',
  'Notifications': 'Bildirimler',
  'Not supported in this browser.': 'Bu tarayıcıda desteklenmiyor.',
  'Push notifications': 'Anlık bildirimler',
  'Rest-timer alerts, even if Loadout is closed.': 'Loadout kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Loadout — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Loadout\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
  ...
  "Reload Loadout": "Loadout'u yeniden yükle",
  ...
  "3x/week · Mon Push · Wed Pull · Fri Legs": "Haftada 3x · Pzt Push · Çar Pull · Cum Bacak",
  "Upper / Lower": "Üst / Alt Vücut",
  "4x/week · Mon+Thu Upper · Tue+Fri Lower": "Haftada 4x · Pzt+Per üst · Sal+Cum alt",
  "Full Body": "Tüm Vücut",
  "3x/week · Mon · Wed · Fri": "Haftada 3x · Pzt · Çar · Cum",
  "5×5 Strength": "5×5 Güç",
  "3x/week · alternating A/B · Mon A · Wed B · Fri A": "Haftada 3x · A/B dönüşümlü · Pzt A · Çar B · Cum A",
  ...
  "Active — manage or cancel anytime in Google Play.": "Aktif — istediğin zaman Google Play'den yönet veya iptal et.",
  "{0}/month · full library, every starter plan": "{0}/ay · tam kütüphane, tüm başlangıç planları",
  "Already subscribed on another device?": "Başka bir cihazda zaten abone misin?",
  "Checking…": "Kontrol ediliyor…",
  "You’re a Loadout Premium member": "Loadout Premium üyesisin",
  "Welcome to Loadout Premium!": "Loadout Premium'a hoş geldin!",
  "Subscriptions are only available in the Play Store version of the app.": "Abonelikler yalnızca uygulamanın Play Store sürümünde kullanılabilir.",
  "Subscription restored.": "Abonelik geri yüklendi.",
  "No active subscription found for this account.": "Bu hesap için aktif bir abonelik bulunamadı.",
  "Active — a gift, free forever.": "Aktif — bir hediye, sonsuza dek ücretsiz.",
  "Redeem gift code": "Hediye kodunu kullan",
  "Someone gave you a code for free Loadout Premium. Enter it below.": "Biri sana ücretsiz Loadout Premium için bir kod verdi. Aşağıya gir.",
  "Gift code": "Hediye kodu",
  "Redeem": "Kullan",
  "Loadout Premium unlocked — enjoy!": "Loadout Premium açıldı — keyfini çıkar!",
  "That code isn’t valid — check it and try again.": "Bu kod geçerli değil — kontrol edip tekrar dene.",
}
