...
export default {
  ...
  'Forge shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Forge bugün planlanan antrenmanı gösterir ve geçen seferki ağırlıklarını otomatik doldurur. Her seti kaydettikçe dinlenme sayacı ve ilerleme otomatik çalışır.",
  ...
  'Rest-timer alerts, even if Forge is closed.': 'Forge kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Forge — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Forge\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
  ...
  "You’re a Forge Premium member": "Forge Premium üyesisin",
  "Welcome to Forge Premium!": "Forge Premium'a hoş geldin!",
