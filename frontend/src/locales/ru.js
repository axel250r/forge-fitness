...
export default {
  ...
  'Forge shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Forge показывает запланированную на сегодня тренировку и подставляет твои веса с прошлого раза. Таймер отдыха и прогрессия работают автоматически, пока ты записываешь каждый подход.",
  ...
  'Rest-timer alerts, even if Forge is closed.': 'Оповещения таймера отдыха, даже если Forge закрыт.',
  ...
  'A small file a friend imports into their own Forge — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Forge — только программы, без твоих тренировок и взвешиваний.',
  ...
  "Checking…": "Проверка…",
  "You’re a Forge Premium member": "Вы участник Forge Premium",
  "Welcome to Forge Premium!": "Добро пожаловать в Forge Premium!",
