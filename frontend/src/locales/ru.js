...
export default {
  ...
  'Search or filter by body part and equipment. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.': "Ищи или фильтруй по части тела и оборудованию. Нажми на упражнение, чтобы увидеть полную инструкцию и видео-демонстрацию, или «План», чтобы сразу добавить его в тренировку.",
  'Got it': "Понятно",
