...
export default {
  "This exercise is part of Loadout Premium — skip it or unlock full access to train it.": "Это упражнение входит в Loadout Premium — пропусти его или открой полный доступ, чтобы выполнить.",
  ...
  "This exercise, its demo video and full instructions are part of Loadout Premium.": "Это упражнение, его видео-демонстрация и полная инструкция входят в Loadout Premium.",
  "Unlock Loadout Premium": "Открыть Loadout Premium",
  ...
  "Subscribe — {0}/month": "Оформить подписку — {0}/мес",
  "Subscriptions aren’t live yet — check back soon.": "Подписки пока недоступны.",
  "Maybe later": "Позже",
  "Premium": "Премиум",
  'This is your week at a glance. Tap Start to train today’s routine, or log your body weight below to track it over time.': "Вот твоя неделя одним взглядом. Нажми «Старт», чтобы выполнить сегодняшнюю тренировку, или запиши свой вес ниже, чтобы следить за его изменением.",
  'Tap a day to assign it a routine. Tap a routine below to edit its exercises — or load a starter plan if you don’t have one yet.': "Нажми на день, чтобы назначить ему тренировку. Нажми на тренировку ниже, чтобы изменить упражнения — или загрузи стартовый план, если у тебя его ещё нет.",
  'Loadout shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Loadout показывает запланированную на сегодня тренировку и подставляет твои веса с прошлого раза. Таймер отдыха и прогрессия работают автоматически, пока ты записываешь каждый подход.",
  'Track your body weight trend, workout streak, estimated 1RM and which muscles you’ve trained. Tap any exercise below to see its full history.': "Следи за динамикой веса, серией тренировок, расчётным 1ПМ и тем, какие мышцы ты прорабатывал. Нажми на упражнение ниже, чтобы увидеть его полную историю.",
  'Gym': "Спортзал",
  'At home': "Дома",
  "Search or filter by body part and equipment. Switch Gym / At home to only see exercises you can actually do there. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.": "Ищите или фильтруйте по группе мышц и оборудованию. Переключайтесь между Спортзал / Дома, чтобы видеть только те упражнения, которые там реально можно выполнить. Нажмите на упражнение, чтобы увидеть полную инструкцию и видео с демонстрацией, или на План, чтобы добавить его прямо в программу.",
  'Got it': "Понятно",
  'Prefer to figure things out yourself?': "Предпочитаешь разобраться сам?",
  'Turn tips off here': "Отключить подсказки здесь",
  'Contextual tips': "Контекстные подсказки",
  'Short notes on each screen, the first time you open it': "Короткие заметки на каждом экране при первом открытии",
  'Confirm': 'Подтвердить',
  'Cancel': 'Отмена',
  'Delete': 'Удалить',
  'Save': 'Сохранить',
  ...
  '{0} min · Follow along on YouTube': "{0} мин · Занимайтесь по видео на YouTube",
  ...
  'open source (AGPL v3)': 'с открытым исходным кодом (AGPL v3)',
  'Notifications': 'Уведомления',
  'Not supported in this browser.': 'Не поддерживается в этом браузере.',
  'Push notifications': 'Push-уведомления',
  'Rest-timer alerts, even if Loadout is closed.': 'Оповещения таймера отдыха, даже если Loadout закрыт.',
  ...
  'A small file a friend imports into their own Loadout — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Loadout — только программы, без твоих тренировок и взвешиваний.',
  ...
  "Reload Loadout": "Перезагрузить Loadout",
  ...
  "3x/week · Mon Push · Wed Pull · Fri Legs": "3 раза/нед · Пн Push · Ср Pull · Пт Ноги",
  "Upper / Lower": "Верх / Низ",
  "4x/week · Mon+Thu Upper · Tue+Fri Lower": "4 раза/нед · Пн+Чт верх · Вт+Пт низ",
  "Full Body": "Всё тело",
  "3x/week · Mon · Wed · Fri": "3 раза/нед · Пн · Ср · Пт",
  "5×5 Strength": "Сила 5×5",
  "3x/week · alternating A/B · Mon A · Wed B · Fri A": "3 раза/нед · чередование A/B · Пн A · Ср B · Пт A",
  ...
  "Active — manage or cancel anytime in Google Play.": "Активна — управляйте или отмените в любой момент в Google Play.",
  "{0}/month · full library, every starter plan": "{0}/мес · вся библиотека, все стартовые планы",
  "Already subscribed on another device?": "Уже подписаны на другом устройстве?",
  "Checking…": "Проверка…",
  "You’re a Loadout Premium member": "Вы участник Loadout Premium",
  "Welcome to Loadout Premium!": "Добро пожаловать в Loadout Premium!",
  "Subscriptions are only available in the Play Store version of the app.": "Подписки доступны только в версии приложения из Play Store.",
  "Subscription restored.": "Подписка восстановлена.",
  "No active subscription found for this account.": "Активная подписка для этого аккаунта не найдена.",
  "Active — a gift, free forever.": "Активна — подарок, бесплатно навсегда.",
  "Redeem gift code": "Активировать подарочный код",
  "Someone gave you a code for free Loadout Premium. Enter it below.": "Кто-то подарил вам код для бесплатного Loadout Premium. Введите его ниже.",
  "Gift code": "Подарочный код",
  "Redeem": "Активировать",
  "Loadout Premium unlocked — enjoy!": "Loadout Premium разблокирован — приятных тренировок!",
  "That code isn’t valid — check it and try again.": "Код недействителен — проверьте его и попробуйте снова.",
}
