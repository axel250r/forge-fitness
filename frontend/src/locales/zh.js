...
export default {
  "This exercise is part of Loadout Premium — skip it or unlock full access to train it.": "这个动作属于 Loadout 高级版——跳过它，或解锁完整权限来训练它。",
  ...
  "This exercise, its demo video and full instructions are part of Loadout Premium.": "这个动作及其演示视频和完整说明都属于 Loadout 高级版。",
  "Unlock Loadout Premium": "解锁 Loadout 高级版",
  ...
  "Subscribe — {0}/month": "订阅 — 每月 {0}",
  "Subscriptions aren’t live yet — check back soon.": "订阅功能暂未开放。",
  "Maybe later": "以后再说",
  "Premium": "高级版",
  'This is your week at a glance. Tap Start to train today’s routine, or log your body weight below to track it over time.': "这是你这一周的概览。点击“开始”进行今天的训练，或在下面记录体重以追踪变化。",
  'Tap a day to assign it a routine. Tap a routine below to edit its exercises — or load a starter plan if you don’t have one yet.': "点击某一天为其指定训练计划。点击下面的计划可编辑其中的动作——如果还没有计划，可以加载一个入门计划。",
  'Loadout shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Loadout 会显示今天安排的训练，并自动填入你上次的重量。休息计时和渐进增重会在你记录每组时自动进行。",
  'Track your body weight trend, workout streak, estimated 1RM and which muscles you’ve trained. Tap any exercise below to see its full history.': "追踪你的体重趋势、连续训练天数、预估单次最大重量（1RM），以及练到了哪些肌肉。点击下面的动作查看完整记录。",
  'Gym': "健身房",
  'At home': "在家",
  "Search or filter by body part and equipment. Switch Gym / At home to only see exercises you can actually do there. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.": "按身体部位和器械搜索或筛选。切换健身房/在家，只查看你在那里真正能做的动作。点击某个动作可查看完整说明和演示视频，点击\"计划\"可直接将其添加到训练计划中。",
  'Got it': "知道了",
  'Prefer to figure things out yourself?': "想自己摸索？",
  'Turn tips off here': "在这里关闭提示",
  'Contextual tips': "情境提示",
  'Short notes on each screen, the first time you open it': "每个界面首次打开时的简短说明",
  'Confirm': '确认',
  'Cancel': '取消',
  'Delete': '删除',
  'Save': '保存',
  ...
  'Cardio': '有氧',
  'Short on time': "时间不多",
  '{0} min · Follow along on YouTube': "{0} 分钟 · 跟着 YouTube 视频练",
  'Mobility': "灵活性",
  'Upper Body': "上肢",
  'Lower Body': "下肢",
  'Superset': '超级组',
  ...
  'open source (AGPL v3)': '开源（AGPL v3）',
  'Notifications': '通知',
  'Not supported in this browser.': '此浏览器不支持。',
  'Push notifications': '推送通知',
  'Rest-timer alerts, even if Loadout is closed.': '休息计时提醒，即使 Loadout 已关闭。',
  ...
  'A small file a friend imports into their own Loadout — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 Loadout——只有训练日，不包含你的训练记录或体重。',
  ...
  'this isn’t a Loadout plan file': '这不是 Loadout 计划文件',
  'Shared routine': '共享的训练日',
  'Unknown exercise': '未知动作',
  'Weekly Training Plan': '每周训练计划',
  'Made with Loadout': '使用 Loadout 制作',
  ...
  "Exercise": "动作",
  "Push / Pull / Legs": "Push / Pull / 腿",
  "3x/week · Mon Push · Wed Pull · Fri Legs": "每周3次 · 周一推 · 周三拉 · 周五腿",
  "Upper / Lower": "上肢 / 下肢",
  "4x/week · Mon+Thu Upper · Tue+Fri Lower": "每周4次 · 周一+周四上肢 · 周二+周五下肢",
  "Full Body": "全身",
  "3x/week · Mon · Wed · Fri": "每周3次 · 周一 · 周三 · 周五",
  "5×5 Strength": "5×5 力量",
  "3x/week · alternating A/B · Mon A · Wed B · Fri A": "每周3次 · A/B交替 · 周一A · 周三B · 周五A",
  ...
  "Active — manage or cancel anytime in Google Play.": "已激活——随时在 Google Play 中管理或取消。",
  "{0}/month · full library, every starter plan": "每月{0} · 完整曲库、所有入门计划",
  "Already subscribed on another device?": "已经在其他设备上订阅了？",
  "Checking…": "检查中…",
  "You’re a Loadout Premium member": "你是 Loadout Premium 会员",
  "Welcome to Loadout Premium!": "欢迎加入 Loadout Premium！",
  "Subscriptions are only available in the Play Store version of the app.": "订阅仅在应用的 Play 商店版本中可用。",
  "Subscription restored.": "订阅已恢复。",
  "No active subscription found for this account.": "未找到此账户的有效订阅。",
  "Active — a gift, free forever.": "已激活——礼物，永久免费。",
  "Redeem gift code": "兑换礼品码",
  "Someone gave you a code for free Loadout Premium. Enter it below.": "有人送给你一个免费 Loadout Premium 的礼品码，请在下方输入。",
  "Gift code": "礼品码",
  "Redeem": "兑换",
  "Loadout Premium unlocked — enjoy!": "Loadout Premium 已解锁——尽情训练吧！",
  "That code isn’t valid — check it and try again.": "该代码无效——请检查后重试。",
}
