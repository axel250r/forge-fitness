...
export default {
  ...
  'Search or filter by body part and equipment. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.': "按身体部位和器材搜索或筛选。点击动作查看完整说明和演示视频，或点击“计划”直接加入训练计划。",
  'Got it': "知道了",
