...
export default {
  ...
  'Forge shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Forge 会显示今天安排的训练，并自动填入你上次的重量。休息计时和渐进增重会在你记录每组时自动进行。",
  ...
  'Rest-timer alerts, even if Forge is closed.': '休息计时提醒，即使 Forge 已关闭。',
  ...
  'A small file a friend imports into their own Forge — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 Forge——只有训练日，不包含你的训练记录或体重。',
  ...
  'this isn’t a Forge plan file': '这不是 Forge 计划文件',
  'Shared routine': '共享的训练日',
  'Unknown exercise': '未知动作',
  'Weekly Training Plan': '每周训练计划',
  'Made with Forge': '使用 Forge 制作',
  ...
  "Checking…": "检查中…",
  "You’re a Forge Premium member": "你是 Forge Premium 会员",
  "Welcome to Forge Premium!": "欢迎加入 Forge Premium！",
