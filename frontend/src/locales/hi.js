...
export default {
  "This exercise is part of Loadout Premium — skip it or unlock full access to train it.": "यह व्यायाम Loadout Premium का हिस्सा है — इसे छोड़ें या इसे करने के लिए पूरी पहुँच अनलॉक करें।",
  ...
  "This exercise, its demo video and full instructions are part of Loadout Premium.": "यह व्यायाम, इसका डेमो वीडियो और पूरे निर्देश Loadout Premium का हिस्सा हैं।",
  "Unlock Loadout Premium": "Loadout Premium अनलॉक करें",
  ...
  "Subscribe — {0}/month": "सब्सक्राइब करें — {0}/महीना",
  "Subscriptions aren’t live yet — check back soon.": "सब्सक्रिप्शन अभी उपलब्ध नहीं हैं।",
  "Maybe later": "बाद में",
  "Premium": "प्रीमियम",
  'This is your week at a glance. Tap Start to train today’s routine, or log your body weight below to track it over time.': "यह रही आपके हफ़्ते की झलक। आज की रूटीन ट्रेन करने के लिए 'शुरू' दबाएँ, या समय के साथ ट्रैक करने के लिए नीचे अपना वज़न दर्ज करें।",
  'Tap a day to assign it a routine. Tap a routine below to edit its exercises — or load a starter plan if you don’t have one yet.': "किसी दिन को रूटीन देने के लिए उसे दबाएँ। नीचे किसी रूटीन के व्यायाम बदलने के लिए उसे दबाएँ — या अगर अभी कोई नहीं है तो स्टार्टर प्लान लोड करें।",
  'Loadout shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Loadout आज की तय रूटीन दिखाता है और पिछली बार के वज़न पहले से भर देता है। हर सेट दर्ज करते ही आराम टाइमर और प्रगति अपने आप काम करती है।",
  'Track your body weight trend, workout streak, estimated 1RM and which muscles you’ve trained. Tap any exercise below to see its full history.': "अपने वज़न का रुझान, वर्कआउट स्ट्रीक, अनुमानित 1RM और कौन-सी मांसपेशियाँ ट्रेन कीं — यह सब ट्रैक करें। पूरा इतिहास देखने के लिए नीचे किसी व्यायाम को दबाएँ।",
  'Gym': "जिम",
  'At home': "घर पर",
  "Search or filter by body part and equipment. Switch Gym / At home to only see exercises you can actually do there. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.": "शरीर के हिस्से और उपकरण के अनुसार खोजें या फ़िल्टर करें। वहां वाकई कर सकने वाले व्यायाम देखने के लिए जिम / घर पर के बीच बदलें। पूरे निर्देश और डेमो वीडियो देखने के लिए किसी व्यायाम को टैप करें, या इसे सीधे रूटीन में जोड़ने के लिए प्लान को टैप करें।",
  'Got it': "समझ गया",
  'Prefer to figure things out yourself?': "खुद पता लगाना पसंद करेंगे?",
  'Turn tips off here': "यहाँ टिप्स बंद करें",
  'Contextual tips': "प्रासंगिक सुझाव",
  'Short notes on each screen, the first time you open it': "हर स्क्रीन पहली बार खोलने पर छोटा नोट",
  'Confirm': 'पुष्टि करें',
  'Cancel': 'रद्द करें',
  'Delete': 'हटाएँ',
  'Save': 'सहेजें',
  ...
  'routine': 'रूटीन',
  'Cardio': 'कार्डियो',
  'Short on time': "कम समय",
  '{0} min · Follow along on YouTube': "{0} मिनट · YouTube पर वीडियो के साथ करें",
  'Mobility': "गतिशीलता",
  ...
  'open source (AGPL v3)': 'ओपन सोर्स (AGPL v3)',
  'Notifications': 'सूचनाएँ',
  'Not supported in this browser.': 'इस ब्राउज़र में समर्थित नहीं।',
  'Push notifications': 'पुश सूचनाएँ',
  'Rest-timer alerts, even if Loadout is closed.': 'आराम टाइमर अलर्ट, Loadout बंद होने पर भी।',
  ...
  'A small file a friend imports into their own Loadout — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने Loadout में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  "Reload Loadout": "Loadout फिर से लोड करें",
  ...
  "Exercise": "व्यायाम",
  "Push / Pull / Legs": "Push / Pull / टांगें",
  "3x/week · Mon Push · Wed Pull · Fri Legs": "सप्ताह में 3x · सोम Push · बुध Pull · शुक्र टांगें",
  "Upper / Lower": "ऊपरी / निचला शरीर",
  "4x/week · Mon+Thu Upper · Tue+Fri Lower": "सप्ताह में 4x · सोम+गुरु ऊपरी · मंगल+शुक्र निचला",
  "Full Body": "पूरा शरीर",
  "3x/week · Mon · Wed · Fri": "सप्ताह में 3x · सोम · बुध · शुक्र",
  "5×5 Strength": "5×5 शक्ति",
  "3x/week · alternating A/B · Mon A · Wed B · Fri A": "सप्ताह में 3x · A/B बारी-बारी · सोम A · बुध B · शुक्र A",
  ...
  "Restore purchase": "खरीद पुनर्स्थापित करें",
  "Loadout Premium": "Loadout Premium",
  "Active — manage or cancel anytime in Google Play.": "सक्रिय — कभी भी Google Play में प्रबंधित या रद्द करें।",
  "{0}/month · full library, every starter plan": "{0}/माह · पूरी लाइब्रेरी, सभी स्टार्टर प्लान",
  "Already subscribed on another device?": "क्या पहले से किसी और डिवाइस पर सब्सक्राइब किया है?",
  "Checking…": "जांच हो रही है…",
  "You’re a Loadout Premium member": "आप Loadout Premium सदस्य हैं",
  "Welcome to Loadout Premium!": "Loadout Premium में आपका स्वागत है!",
  "Subscriptions are only available in the Play Store version of the app.": "सब्सक्रिप्शन केवल ऐप के Play Store वर्शन में उपलब्ध हैं।",
  "Subscription restored.": "सब्सक्रिप्शन पुनर्स्थापित हो गई।",
  "No active subscription found for this account.": "इस खाते के लिए कोई सक्रिय सब्सक्रिप्शन नहीं मिला।",
  "Active — a gift, free forever.": "सक्रिय — एक उपहार, हमेशा के लिए मुफ़्त।",
  "Redeem gift code": "गिफ़्ट कोड रिडीम करें",
  "Someone gave you a code for free Loadout Premium. Enter it below.": "किसी ने आपको मुफ़्त Loadout Premium के लिए एक कोड दिया है। इसे नीचे दर्ज करें।",
  "Gift code": "गिफ़्ट कोड",
  "Redeem": "रिडीम करें",
  "Loadout Premium unlocked — enjoy!": "Loadout Premium अनलॉक हो गया — इसका आनंद लें!",
  "That code isn’t valid — check it and try again.": "यह कोड मान्य नहीं है — इसे जांचें और फिर से प्रयास करें।",
}
