...
export default {
  ...
  'Forge shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Forge आज की तय रूटीन दिखाता है और पिछली बार के वज़न पहले से भर देता है। हर सेट दर्ज करते ही आराम टाइमर और प्रगति अपने आप काम करती है।",
  ...
  'Rest-timer alerts, even if Forge is closed.': 'आराम टाइमर अलर्ट, Forge बंद होने पर भी।',
  ...
  'A small file a friend imports into their own Forge — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने Forge में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  "You’re a Forge Premium member": "आप Forge Premium सदस्य हैं",
  "Welcome to Forge Premium!": "Forge Premium में आपका स्वागत है!",
