...
export default {
  "This exercise is part of Forge Premium — skip it or unlock full access to train it.": "Este ejercicio es parte de Forge Premium — sáltalo o desbloquea el acceso completo para entrenarlo.",
  ...
  "This exercise, its demo video and full instructions are part of Forge Premium.": "Este ejercicio, su video de demostración y las instrucciones completas son parte de Forge Premium.",
  "Unlock Forge Premium": "Desbloquear Forge Premium",
  ...
  'Forge shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Forge muestra la rutina planeada para hoy y precarga tus pesos de la última vez. El temporizador de descanso y la progresión funcionan solos a medida que registras cada serie.",
  ...
  'Rest-timer alerts, even if Forge is closed.': 'Avisos del temporizador de descanso, incluso con Forge cerrado.',
  ...
  'A small file a friend imports into their own Forge — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio Forge: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  "You’re a Forge Premium member": "Eres miembro de Forge Premium",
  "Welcome to Forge Premium!": "¡Bienvenido a Forge Premium!",
