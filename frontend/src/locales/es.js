...
export default {
  "This exercise is part of Loadout Premium — skip it or unlock full access to train it.": "Este ejercicio es parte de Loadout Premium — sáltalo o desbloquea el acceso completo para entrenarlo.",
  "Plate calculator": "Calculadora de discos",
  "Total weight on the bar, including the bar itself.": "Peso total en la barra, incluida la barra.",
  "Bar weight": "Peso de la barra",
  "Per side ({0} {1}):": "Por lado ({0} {1}):",
  "{0} {1} short per side — no combination of your plates hits it exactly.": "Faltan {0} {1} por lado — ninguna combinación de tus discos llega exacto.",
  "The bar alone already covers this weight.": "La barra sola ya cubre este peso.",
  "This exercise, its demo video and full instructions are part of Loadout Premium.": "Este ejercicio, su video de demostración y las instrucciones completas son parte de Loadout Premium.",
  "Unlock Loadout Premium": "Desbloquear Loadout Premium",
  "Full access to the 1,324-exercise library with video demos, every starter plan, and everything still to come.": "Acceso completo a la biblioteca de 1.324 ejercicios con videos de demostración, todos los planes iniciales y todo lo que viene.",
  "Subscribe — {0}/month": "Suscribirse — {0}/mes",
  "Subscriptions aren’t live yet — check back soon.": "Las suscripciones aún no están disponibles.",
  "Maybe later": "Más tarde",
  "Premium": "Premium",
  'This is your week at a glance. Tap Start to train today’s routine, or log your body weight below to track it over time.': "Esta es tu semana de un vistazo. Toca Empezar para entrenar la rutina de hoy, o registra tu peso corporal abajo para seguirlo con el tiempo.",
  'Tap a day to assign it a routine. Tap a routine below to edit its exercises — or load a starter plan if you don’t have one yet.': "Toca un día para asignarle una rutina. Toca una rutina abajo para editar sus ejercicios — o carga un plan inicial si todavía no tienes uno.",
  'Loadout shows today’s planned routine and pre-fills your weights from last time. Rest timers and progression happen automatically as you log each set.': "Loadout muestra la rutina planeada para hoy y precarga tus pesos de la última vez. El temporizador de descanso y la progresión funcionan solos a medida que registras cada serie.",
  'Track your body weight trend, workout streak, estimated 1RM and which muscles you’ve trained. Tap any exercise below to see its full history.': "Sigue tu tendencia de peso corporal, racha de entrenamientos, 1RM estimado y qué músculos entrenaste. Toca cualquier ejercicio abajo para ver su historial completo.",
  'Gym': "Gimnasio",
  'At home': "En casa",
  "Search or filter by body part and equipment. Switch Gym / At home to only see exercises you can actually do there. Tap an exercise for its full instructions and demo video, or Plan to add it straight to a routine.": "Busca o filtra por parte del cuerpo y equipo. Cambia entre Gimnasio / En casa para ver solo los ejercicios que puedes hacer ahí. Toca un ejercicio para ver sus instrucciones completas y video de demostración, o Plan para agregarlo directo a una rutina.",
  'Got it': "Entendido",
  'Prefer to figure things out yourself?': "¿Prefieres descubrirlo por tu cuenta?",
  'Turn tips off here': "Desactiva los consejos aquí",
  'Contextual tips': "Consejos contextuales",
  'Short notes on each screen, the first time you open it': "Notas breves en cada pantalla, la primera vez que la abres",
  'Confirm': 'Confirmar',
  'Cancel': 'Cancelar',
  'Delete': 'Eliminar',
  'Save': 'Guardar',
  ...
  'routine': 'rutina',
  'Cardio': 'Cardio',
  'Short on time': "Poco tiempo",
  '{0} min · Follow along on YouTube': "{0} min · Sigue el video en YouTube",
  'Mobility': "Movilidad",
  ...
  '{0} exercises with YouTube demos': "{0} ejercicios con demos de YouTube",
  'Search…': 'Buscar…',
  ...
  'open source (AGPL v3)': 'código abierto (AGPL v3)',
  'Notifications': 'Notificaciones',
  'Not supported in this browser.': 'No compatible con este navegador.',
  'Push notifications': 'Notificaciones push',
  'Rest-timer alerts, even if Loadout is closed.': 'Avisos del temporizador de descanso, incluso con Loadout cerrado.',
  ...
  'A small file a friend imports into their own Loadout — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio Loadout: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  "Reload Loadout": "Recargar Loadout",
  "Watch demo on YouTube": "Ver demostración en YouTube",
  "No exercises yet.": "Todavía no hay ejercicios.",
  "{0} loaded": "{0} cargado",
  "A ready-made week — pick what fits your schedule. You can tweak anything after.": "Una semana ya armada — elige la que se ajuste a tu horario. Puedes ajustar cualquier cosa después.",
  "Exercise": "Ejercicio",
  "Push / Pull / Legs": "Push / Pull / Piernas",
  "3x/week · Mon Push · Wed Pull · Fri Legs": "3x/semana · Lun Push · Mié Pull · Vie Piernas",
  "Upper / Lower": "Tren superior / Tren inferior",
  "4x/week · Mon+Thu Upper · Tue+Fri Lower": "4x/semana · Lun+Jue superior · Mar+Vie inferior",
  "Full Body": "Cuerpo completo",
  "3x/week · Mon · Wed · Fri": "3x/semana · Lun · Mié · Vie",
  "5×5 Strength": "Fuerza 5×5",
  "3x/week · alternating A/B · Mon A · Wed B · Fri A": "3x/semana · alterna A/B · Lun A · Mié B · Vie A",
  "3x/week · bodyweight + dumbbells · Mon · Wed · Fri": "3x/semana · peso corporal + mancuernas · Lun · Mié · Vie",
  "{0} full workouts, one video each": "{0} entrenamientos completos, un video cada uno",
  "No time for a full logged workout? Pick one of these and follow along — it opens straight in YouTube, no setup here.": "¿Sin tiempo para un entrenamiento completo con registro? Elige uno de estos y síguelo — se abre directo en YouTube, sin configurar nada aquí.",
  ...
  "Active — manage or cancel anytime in Google Play.": "Activa — gestiónala o cancélala cuando quieras en Google Play.",
  "{0}/month · full library, every starter plan": "{0}/mes · biblioteca completa, todos los planes de inicio",
  "Already subscribed on another device?": "¿Ya te suscribiste en otro dispositivo?",
  "Checking…": "Comprobando…",
  "You’re a Loadout Premium member": "Eres miembro de Loadout Premium",
  "Welcome to Loadout Premium!": "¡Bienvenido a Loadout Premium!",
  "Subscriptions are only available in the Play Store version of the app.": "Las suscripciones solo están disponibles en la versión de Play Store de la app.",
  "Subscription restored.": "Suscripción restaurada.",
  "No active subscription found for this account.": "No se encontró una suscripción activa para esta cuenta.",
  "Active — a gift, free forever.": "Activa — un regalo, gratis para siempre.",
  "Redeem gift code": "Canjear código de regalo",
  "Someone gave you a code for free Loadout Premium. Enter it below.": "Alguien te dio un código para Loadout Premium gratis. Ingrésalo abajo.",
  "Gift code": "Código de regalo",
  "Redeem": "Canjear",
  "Loadout Premium unlocked — enjoy!": "¡Loadout Premium desbloqueado — disfrútalo!",
  "That code isn’t valid — check it and try again.": "Ese código no es válido — revísalo e inténtalo de nuevo.",
}
