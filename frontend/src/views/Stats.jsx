...
export default function Stats() {
  ...
  return <>
    ...
    <HelpTip id="stats" text="Track your body weight trend, workout streak, estimated 1RM and which muscles you’ve trained. Tap any exercise below to see its full history." />
